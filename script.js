...
const apiUrl1 = 'https://youtube.googleapis.com/youtube/v3/videos?part=statistics%2Csnippet&id=0bIRwBpBcZQ%2CRmTq3cJqyCo%2CFcQ6oB1JPiA%2CfE2h3lGlOsk%2CpNfTK39k55U%2CzndvqTc4P9I%2C_ysomCGaZLw%2CMjCZfZfucEc%2CwTowEKjDGkU%2CHbb5GPxXF1w%2CzugAhfd2r0g%2C6uZy86ePgO0%2Ckrzf1hkFAZA%2CF-QTb-0wRGk&key=AIzaSyCSxEEH9DjflJ1Czxk_wH6_zQWRlbtmT4E';
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer62.update(start - 13420892)
          start += increment;
        }
      }, 5000)
    ...
    const increment = 3;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer72.update(start - 7199609)
          start += increment;
        }
      }, 4000)
    ...
    const increment = 4;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer82.update(start - 514860465)
          start += increment;
        }
      }, 3000)
    ...
    const increment = 1;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer92.update(start - 318861903)
          start += increment;
        }
      }, 20000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer102.update(start - 261953116)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer112.update(start - 245500729)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer122.update(start - 237363065)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer132.update(start - 204580447)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer142.update(start - 138653724)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer152.update(start - 137928169)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer162.update(start - 24884521)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer172.update(start - 22458381)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer182.update(start - 15406838)
          start += increment;
        }
      }, 30000)
    ...
    .then((data) => {
      ...
      setInterval(() => {
        if (start <= max) {
          ...
          odometer1.update(start - 40000000)
          odometer2.update(start - 32316813)
          start += increment;
        }
      }, 3000)
