    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer62.update(start - 13184175)
          start += increment;
        }
      }, 5000)
    ...
    const increment = 3;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer72.update(start - 6814110)
          start += increment;
        }
      }, 4000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer162.update(start - 24792244)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer172.update(start - 22393955)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer182.update(start - 15327653)
          start += increment;
        }
      }, 30000)
