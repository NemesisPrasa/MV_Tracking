    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer62.update(start - 12600408)
          start += increment;
        }
      }, 5000)
    ...
    const increment = 3;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer72.update(start - 5909365)
          start += increment;
        }
      }, 4000)
    ...
    const increment = 4;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer82.update(start - 513066148)
          start += increment;
        }
      }, 3000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer92.update(start - 318482541)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer102.update(start - 261739398)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer112.update(start - 245124582)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer122.update(start - 236413481)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer132.update(start - 204357641)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer142.update(start - 137965491)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer152.update(start - 136411375)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer162.update(start - 24624638)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer172.update(start - 22271253)
          start += increment;
        }
      }, 10000)
    ...
    const increment = 2;
     ...
     setInterval(() => {
        if (start <= max) {
          ...
          odometer182.update(start - 15168996)
          start += increment;
        }
      }, 30000)
    ...
    .then((data) => {
      ...
      setInterval(() => {
        if (start <= max) {
          ...
          odometer2.update(start - 17848799)
          start += increment;
        }
      }, 3000)
